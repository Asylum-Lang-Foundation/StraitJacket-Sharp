...
namespace StraitJacket {
    ...
    public class Compiler {
        ...
        // Visit a file.
        public Constructs.AST VisitFile(Stream s, VisitMode mode) {
        ...
        public Constructs.AST VisitFile(string s, VisitMode mode) {
            Constructs.AST ret;
        ...
        public void AddFile(string filePath) {
            if (files.Contains(filePath)) {
                ...
                Console.WriteLine("ERROR: You can't pass the same file to compile twice, that's insane!");
            ...
            foreach (VisitMode mode in Enum.GetValues(typeof(VisitMode))) {
                ...
                if (mode != VisitMode.GetCode) {
                    ...
                    foreach (var s in files) {
                        ...
                        Directory.CreateDirectory(rootFolder + "/bin/" + Path.GetDirectoryName(s));
                        mod.WriteBitcodeToFile(rootFolder + "/bin/" + Path.GetFileNameWithoutExtension(s) + ".bc");
